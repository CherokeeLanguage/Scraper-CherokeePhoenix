...
public interface CacheDao {
	...
	@SqlUpdate("create CACHED table if not exists " + TABLE_PDF //
			+ "(id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY," //
			+ " url VARCHAR(254) DEFAULT ''," //
	...
	@SqlUpdate("create INDEX if not exists " + TABLE_PDF + "_url on " + TABLE_PDF + "(url)")
	void _createTable2Index1();

	@SqlUpdate("create INDEX if not exists " + TABLE_PDF + "_cherokee on " + TABLE_PDF + "(cherokee)")
	void _createTable2Index2();
